...
module.exports = {
	"reload_tiddlers": function() {
		...
		var msg = "Tiddlers reloaded from: " + resolvedWikiPath + "\nBefore: " + countBefore + ", After: " + countAfter + " (added: " + added + ", updated: " + updated + ", unchanged: " + unchanged + ", skipped-system: " + skippedSystem + ", deleted: " + deleted + ")";
