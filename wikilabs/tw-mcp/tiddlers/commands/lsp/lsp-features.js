...
var links = require("$:/core/modules/commands/inspect/lsp/lsp-links.js"),
	...
	tokens = require("$:/core/modules/commands/inspect/lsp/lsp-tokens.js");

exports.diagnostics = check.diagnostics;
exports.listUndefinedCalls = check.listUndefinedCalls;
exports.undefinedCallsInFile = check.undefinedCallsInFile;
exports.summarizeUndefinedCalls = check.summarize;
...
exports.semanticTokens = tokens.semanticTokens;
exports.SEMANTIC_TOKENS_LEGEND = tokens.LEGEND;
